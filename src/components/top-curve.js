...
const styles = StyleSheet.create({
  ...
  cone1: {
    ...
    position: 'absolute',
    top: Platform.OS === 'android' ? -40 : undefined,
  ...
  image: {
    ...
    top: Platform.OS === 'android' ? 2 : -15,
    right: Platform.OS === 'android' ? 8 : undefined,
  },
  modalCone1: {
    width: 60,
    height: 90,
    backgroundColor: '#44CF38',
    position: 'absolute',
    top: Platform.OS === 'android' ? -25 : -100,
  ...
  modalCone2: {
    width: 100,
    height: 90,
    top: Platform.OS === 'android' ? -32 : -120,
    backgroundColor: '#5B9CFF',
    position: 'absolute',
